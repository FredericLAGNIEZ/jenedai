...
def train(df, logger_file):
    ...
    from constants import TRACKING_URI, MODEL_NAME
...
def etl(source: str = "s3"):   
    ...
    try:
        if source == "s3":
            ...
            NUMERIC_COLS = ["total_energie_soutiree_wh", "nb_points_soutirage","lat","lon","temperature_2m_mean","relative_humidity_mean","precipitation_sum"]
